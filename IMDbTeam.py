...
# Y_test_scores_1 = np.loadtxt("class_sums/IMDBAnalyzer_%d_10000_8000_4.00_1_2_32_1_word_0.75_5000.txt" % (args.epoch), delimiter=',')
# Y_test_scores_2 = np.loadtxt("class_sums/IMDBAnalyzer_%d_10000_8000_8.00_1_2_32_1_word_0.75_5000.txt" % (args.epoch), delimiter=',')
# Y_test_scores_3 = np.loadtxt("class_sums/IMDBAnalyzer_%d_10000_8000_16.00_1_2_32_1_word_0.75_5000.txt" % (args.epoch), delimiter=',')
# Y_test_scores_4 = np.loadtxt("class_sums/IMDBAnalyzer_%d_10000_8000_32.00_1_2_32_1_word_0.75_5000.txt" % (args.epoch), delimiter=',')
...
for i in range(Y_test.shape[0]):
    ...
    votes[i] += 1.0*Y_test_scores_3[i]/(np.max(Y_test_scores_3) - np.min(Y_test_scores_3))
    votes[i] += 1.0*Y_test_scores_4[i]/(np.max(Y_test_scores_4) - np.min(Y_test_scores_4))
