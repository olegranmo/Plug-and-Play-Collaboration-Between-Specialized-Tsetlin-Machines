...
In the ensuing normalization step, the class sums of each TM <img src="http://latex.codecogs.com/svg.latex?t" border="0" valign="middle"/> are divided by the difference between the largest and smallest class sums from the data <img src="http://latex.codecogs.com/svg.latex?\mathcal{D}" border="0" valign="middle"/>: <img src="http://latex.codecogs.com/svg.latex?\mathrm{max}_{D}(c^i_{t,d}) - \mathrm{min}_{D}(c^i_{t,d}), d \in D" border="0" valign="middle"/>.
