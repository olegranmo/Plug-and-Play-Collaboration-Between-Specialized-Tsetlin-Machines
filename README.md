...
In the ensuing normalization step, each TM's class sums are divided by the difference between the largest and smallest class sums from the data <img src="http://latex.codecogs.com/svg.latex?d \in \mathcal{D}" border="0" valign="middle"/>:
