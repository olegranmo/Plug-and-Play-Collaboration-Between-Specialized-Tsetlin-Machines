...
In the normal case, a TM, here referred to as <img src="http://latex.codecogs.com/svg.latex?t" border="0" valign="middle"/>, outputs the class <img src="http://latex.codecogs.com/svg.latex?i" border="0" valign="middle"/> with the largest class sum (see [Tsetlin machine](https://github.com/cair/TsetlinMachine)):
...
<p align="left">
When collaborating, however, each TM outputs its class sum <img src="http://latex.codecogs.com/svg.latex?\hat{y}^{i,c}_t" border="0" valign="middle"/> per class instead, with the class sum signifying confidence:
</p>
