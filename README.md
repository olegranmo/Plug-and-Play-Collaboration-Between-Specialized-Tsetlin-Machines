...
Now consider the confidence and accuracy of the Color Thermometers TM in the figure above. Notice how it seems to specialize to get high confidence and accuracy in recognizing color texture. The weakness of the Adaptive Thresholding TM seems to the strength of the Color Thermometers TM, and vice versa. 
